...
When shopping cart additions happen directly as part of the search or autocomplete results whithout a navigation to the product page, the `api.recordSearchAddToCart()` method should be called with the component (type), where addition occurred and the product data:
