...
Merchants can find their token by going to the **Nosto Admin Portal > Account Settings > Authentication Tokens > API\_LIM** and click **Decrypt** _(If as a merchant you don't see the token it's because LIM is not enabled in your account, please contact Support or your Customer Success Manager)_
