...
Take a look at our[\
How to use “Filter and search” in a Widget](https://github.com/Stackla/docs/blob/master/docs/guides/how-to-use-filter-and-search-in-widget/README.md) article for more examples.
