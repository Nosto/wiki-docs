...
A Stackla Widget will be created to demonstrate the use of the [JavaScript API](file:///api-docs/javascript/) to switch the filters being displayed.

#### Filter <a href="#filter" id="filter"></a>

Stackla Filters drive the content being displayed in the Widget, so they are a key resource used for the menu. The [REST API](file:///api-docs/rest/) will be used to grab them from

#### JavaScript API <a href="#javascript-api" id="javascript-api"></a>

The [JavaScript API](file:///api-docs/javascript/) is will be used to talk to the Widget on the site and get it to switch the Filter being displayed.

### The Fun Part <a href="#the-fun-part" id="the-fun-part"></a>
...
#### Create the Example Application <a href="#create-the-example-application" id="create-the-example-application"></a>

To simplify the example, we will create a simple HTML page and will have clickable filters and tags listing.

#### Lets jump to the geek's mode to see how it works. <a href="#lets-jump-to-the-geeks-mode-to-see-how-it-works" id="lets-jump-to-the-geeks-mode-to-see-how-it-works"></a>
...
#### Keyword / Full Text Search <a href="#keyword--full-text-search" id="keyword--full-text-search"></a>
...
<figure><img src="../../../.gitbook/assets/filters-and-search.png" alt=""><figcaption></figcaption></figure>
