---
title: search-variation-implementation
---

The search/category merchandising (universal) API supports specifying the variation ID in requests using the `variationId` property of the [products object](https://search.nosto.com/v1/graphql?ref=InputSearchProducts).
