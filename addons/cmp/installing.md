...
After running the commands above you can login to the store admin. You will find settings for Category personalization and merchandizing module under Stores > Configuration > Services > Nosto CMP.
