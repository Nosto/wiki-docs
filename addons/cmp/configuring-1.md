...
The APPS token should be present to enable the usage of category merchandising. If it missing please reconnect the account by navigating to Marketing -> Nosto -> Nosto Dashboard -> Settings and press on Reconnect.
