...
If you are working on a Single-Page App (SPA) or a Progressive Web Application (PWA) you most likely want to use [Session API](https://github.com/Nosto/techdocs/wiki/SPA:-Implementation-Guide-(Session-API)). Also, please note that you can not use both, Session API and JS API on a same page or application.   
